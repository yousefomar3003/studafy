 ...
 * A leadership-facing snapshot — approvals, attendance, discipline, announcements — complementing
 * the ops-facing admin console rather than replacing it. Each tile owns its own query and
 * loading/error/empty state independently, so one failing endpoint never blocks the others from
...
export default function PrincipalDashboardPage() {
  return (
    <>
      <h1>Principal</h1>
      <p>A live snapshot of approvals, attendance, discipline, and announcements.</p>
