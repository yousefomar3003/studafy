...
| `billing`       | `BILLING`         | 1           | Payment and billing operations. Concurrency of 1 by design — these jobs must be processed strictly in order per instance, not interleaved.                                                |
