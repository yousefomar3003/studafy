/**
 * State-store adapter for attendance exports (ST-175).
 *
 * Maps the canonical lifecycle onto app.report_export_jobs: native statuses are
...
export const createAttendanceReportStore = (): ReportStateStore => ({
